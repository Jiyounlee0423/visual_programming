...
class MW(QWidget):
    ...
    def setup_main_wnd(self):
        lm = QHBoxLayout()
        self.checks = QGroupBox("QGroupBox Grp")
    ...
    def set_radios(self):
        ...
        self.rb_0 = QCheckBox(f"check 0")
        self.rb_1 = QCheckBox(f"check 1")
        self.rb_2 = QCheckBox(f"check 2")
        lm.addWidget(self.rb_0)
        lm.addWidget(self.rb_1)
        lm.addWidget(self.rb_2)
        self.radios.setLayout(lm)
        self.rb_0.clicked.connect(self.toggle_radio_box)
        self.rb_1.clicked.connect(self.toggle_radio_box)
        self.rb_2.clicked.connect(self.toggle_radio_box)
